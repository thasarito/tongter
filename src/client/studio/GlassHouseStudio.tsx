...
function Workspace(){
  ...
  const {open,closePanel}=useStudioChrome();
  useStudioScrollLock();
  useEffect(()=>closePanel(),[view,closePanel]);
  return <main className="studio-root studio-immersive" aria-label="Glass House administrator planning studio" data-saving={pending} data-view={view} data-panel-open={open}>
