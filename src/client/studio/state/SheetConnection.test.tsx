...
describe("sheet autosave",()=>{
 ...
 it("ignores a delayed pre-save refresh even after the entire edit queue drains",async()=>{
  ...
  fireEvent.click(screen.getByText("Edit"));fireEvent.click(screen.getByText("Edit second"));
